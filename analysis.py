...
# THERE IS SHOULD BE A TOOL THAT CAN CALL THIS FILE AND APPLY PANDAS CODE IN THAT FILE THAT IS GENERATED BY MY ASSISTANT AND RETURN BACK THE PANDAS RESULT TO AI ASSISTANT FOR FUTHTHER FORMATTING ACCORDING TO THE SYSTEM MESSAGE. 
import pandas as pd
